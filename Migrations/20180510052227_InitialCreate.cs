        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ounces = table.Column<string>(type: "longtext", nullable: true),
                    RecipeID = table.Column<int>(type: "int", nullable: false),
                    ReplaceeID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Amounts_Recipes_RecipeID",
                        column: x => x.RecipeID,
                        principalTable: "Recipes",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Amounts_Recipes_ReplaceeID",
                        column: x => x.ReplaceeID,
                        principalTable: "Recipes",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collections_Members_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberIngredients", x => x.ID);
                    table.ForeignKey(
                        name: "FK_MemberIngredients_Ingredients_IngredientID",
                        column: x => x.IngredientID,
                        principalTable: "Ingredients",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberIngredients_Members_MemberID",
                        column: x => x.MemberID,
                        principalTable: "Members",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_Members_UserID",
                        column: x => x.UserID,
                        principalTable: "Members",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionRecipes", x => x.ID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Amounts_RecipeID",
                table: "Amounts",
                column: "RecipeID");

            migrationBuilder.CreateIndex(
                name: "IX_Amounts_ReplaceeID",
                table: "Amounts",
                column: "ReplaceeID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionRecipes_CollectionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberIngredients_IngredientID",
                table: "MemberIngredients",
                column: "IngredientID");

            migrationBuilder.CreateIndex(
                name: "IX_MemberIngredients_MemberID",
                table: "MemberIngredients",
                column: "MemberID");
